...
<head>
    ...
    <meta charset="utf-8" />
    <title>404 Error Cover | {{ config('app.name') }}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Aplikasi {{ config('app.name') }}" name="description" />
    <meta content="RSAMtDev" name="author" />
    <!-- App favicon -->
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8">
                    <div class="text-center">
                        <img src="{{asset('template/velzon/assets/images/error400-cover.png')}}" alt="error img" class="img-fluid">
                        <div class="mt-3">
